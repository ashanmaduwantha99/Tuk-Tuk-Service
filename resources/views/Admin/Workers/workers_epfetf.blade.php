...
@section('admin_js')
    <script>
        setTimeout(function () {
            window.location.href= 'http://127.0.0.1:8000/workers_epfetf'; // the redirect goes here
...
@endsection
@section('title') Employees' EPF/ETF @endsection
        ...
        <div class="container-home" id="salary_sheet_update">
            <div class="container-fluid">
                <div class="row" id="calSalary_row2">
                    <div class="col-md-8" id="show_salary_sheet">
                        <div class="section-header text-center">
                            <br>
                            <h3 class="title" id="Header"><b>Employees' EPF/ETF </b></h3>
                        </div>
